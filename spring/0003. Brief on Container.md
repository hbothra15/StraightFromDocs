...
Spring configuration will have atleast one basic thing i.e.
1. XML- `<beans><bean/></beans>`
2. Java Annotation - `@Bean`
3. Java Cod

[^1]: https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/core.html#spring-core
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNDc1NDY2MDAsLTIwODg3NDY2MTJdfQ
==
-->