...
Once our Spring container is up, if we want to access an Object i.e. Bean in context of Spring then all we need 

[^1]: https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/core.html#spring-core
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4MzQzODM3MiwtMTAxNTYwNzY3Miw5OD
